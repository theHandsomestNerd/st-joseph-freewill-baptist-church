...
import {SjfServiceItemNoRefType, SjfServicesSectionType} from "../BlockContentTypes";
...
const SjfServiceItem: FunctionComponent<IProps> = (props: IProps) => {
        ...
        <Accordion onMouseLeave={()=>setMouseEnter(false)} onMouseEnter={()=>setMouseEnter(true)} style={{width:"100%",
            ...
            <AccordionSummary onMouseEnter={()=>setMouseEnter(true)}>
                ...
                <Grid container item>
                    <Grid container item xs={6} spacing={1} alignItems={'center'} alignContent={ 'flex-start'} wrap='nowrap'>
                        ...
                        {/*</Grid>*/}
                        <Grid item>
                            <Typography variant={'body2'} align='center' color={ mouseEnter?"primary":"textPrimary"}
                    ...
                    <Grid container item xs={6} justifyContent='flex-end' alignContent={'center'}>
                        <ArrowDropDown style={{color: imExpanded || mouseEnter? DigitalResumeTheme.palette.primary.main:DigitalResumeTheme.palette.secondary.main}}  color={imExpanded || mouseEnter? "primary":"secondary"}></ArrowDropDown>
                    </Grid>
                </Grid>
            </AccordionSummary>
            <AccordionDetails onMouseEnter={()=>setMouseEnter(true)}>
                <Grid container item spacing={2}>
                    ...
                    {props.service.serviceAmenities?.length > 0 && <Grid item container justifyContent='center'>
                        <Grid item container>
                    ...
                    {props.service.ctaButtonLink && <Grid item container justifyContent='center'>
                        <Button
