  ...
  fields: [
    {
      ...
      of: [
        ...
        {name: 'ThreeColumnImageSection', title: "3 Column Image Section",type: 'reference', to: [{type: 'ThreeColumnImageSection'}]},
        {name: 'HeadlineCTASection', title: "Headline+CTA",type: 'reference', to: [{type: 'HeadlineCTASection'}]},
        {name: 'EventsSection', title: "Events section",type: 'reference', to: [{type: 'EventsSection'}]},
        {name: 'TeamSection', title: "Team Section",type: 'reference', to: [{type: 'TeamSection'}]},
        ...
        {name: 'SjfHeroContentSection', title: "SJF Hero + Content",type: 'reference', to: [{type: 'SjfHeroContentSection'}]},
        {name: 'ConnectWithUsSection', title: "Connect with Us",type: 'reference', to: [{type: 'ConnectWithUsSection'}]},
